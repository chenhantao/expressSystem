        ...
        <ul class="pager">
        	<c:choose>
        		...
        		<c:otherwise>
    				...
    				<li><a href="${path}/courier/receiveorders?page=${page.prePage}&limit=${limit}">&laquo;上一页</a></li>
    			</c:otherwise>
    		</c:choose>
    		<c:choose>
    			<c:when test="${page.pageNum == page.pages }"></c:when>
    			<c:otherwise>
    				<li><a href="${path}/courier/receiveorder?page=${page.nextPage}&limit=${limit}">下一页&raquo;</a></li>
